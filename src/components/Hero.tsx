        ...
        <div className={`mt-32 flex flex-col md:flex-row`}>
            <div>
                ...
                <div>
                    ...
                    <h2 className="hero-headline text-white text-[40px] font-black">
                ...
                <div className='cta-container w-[90%] max-w-[350px] mb-20'>
                    <button
            ...
            <div className="hero-img-container w-[568px] h-[568px] flex-shrink-0 rounded-full bg-[#CBFC01] mt-16">
